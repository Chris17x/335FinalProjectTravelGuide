...
Group Members - Add the name and directory ID (in parentheses) of each member of your team (or your information if you are working by yourself).
...
App Description: Allow users to insert Cities with information, then view the cities in the collection alongside an active weather forcast.
